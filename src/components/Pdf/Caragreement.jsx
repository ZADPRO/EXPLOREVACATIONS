...
export default function PdfVieTour({
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <PDFViewer className="w-full mt-30 max-w-xl h-[100vh]">
        <Document>
          <Page size="A4">
            <View style={{ width: "100%", height: "100%", padding: "40px" }}>
              ...
              >
                ...
                >
                  ...
                  <Text
                    style={{ fontSize: 9, marginLeft: 15, color: "#015195" }}
                  >
              ...
              >
                ...
                >
                  <Text style={{ fontSize: 9, marginBottom: 8, color: "#000" }}>
                    ...
                    <Text style={{ fontWeight: "bold" }}>CustID</Text>
                  </Text>
                </View>
              </View>
              ...
              >
                ...
                >
                  ...
                  <Text style={{ fontSize: 9, marginBottom: 8, color: "#000" }}>
                    ...
                    required Passport, Driver’s License, Physical Credit Card
                    and voucher to the rental desk.
                  </Text>
                  <Text style={{ fontSize: 9, marginBottom: 8, color: "#000" }}>
                    {" "}
                    Please carefully read the supplier's rental agreement and
                    make sure you fully understand it before signing it.
                  </Text>
                  <Text style={{ fontSize: 9, marginBottom: 8, color: "#000" }}>
                    Kind regards,
                    <br />
                ...
                >
                  ...
                  <View style={{ marginTop: "10px" }}>
                    <View style={{ flexDirection: "row", marginBottom: 4 }}>
                      <Text
                        style={{ fontSize: 12, color: "#000", width: "50%" }}
                      >
                        9 5 doors
                      </Text>
                      <Text
                  ...
                  >
                    ** Rental companies can't guarantee availability of a
                    specific car brand/model. However you will always be
                    guaranteed to get at least a similar car from the same
                    class.
                  </Text>
                </View>
            ...
            <View style={{ width: "100%", height: "100%", padding: "40px" }}>
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                ...
                have listed any local fees that you might be liable to pay to
                the car rental company at time of vehicle collection. These are
                the only mandatory fees or services you are required to pay
                locally to the car rental company.
              </Text>
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                ...
                at time of vehicle pickup on our toll free number, 24 hours a
                day, on the number listed below (see Terms and Conditions
                section). HolidayCars.com cannot accept liability for items
                purchased locally.
              </Text>
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                At time of pickup, we also strongly recommend that you check
                that the condition of the vehicle is adequately reflected on the
                rental agreement and that any pre-existing damage is indicated.
                Should you expect to be delayed for the pickup of the vehicle,
                you should also contact us to ensure your vehicle can be
                confirmed after the scheduled timing.
              </Text>
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                It is also your responsibility to be aware of the local driving
                laws and local tolls or stickers required for any country you
                are traveling into. Again, you can call HolidayCars.com on our
                free toll number at any time for advice and assistance.
              </Text>
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                Finally, we strongly recommend that you request and review a
                copy of the rental agreement in English, wherever the car rental
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                The prices given are estimates only and subject to changes
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                ...
                over the age of 65 years. When applicable senior driver
                surcharges or extra insurances are obligatory and mostly payable
                at the time of pick up in the local currency. Senior driver age
                rules are different and depend on the dedicated terms of the
                respective car rental company and location. We strongly
                recommend you check the individual supplier's requirements as
                additional documents may be also required. In some locations,
                for instance, senior drivers must provide a medical certificate
                to confirm that they are medically fit to drive.{" "}
              </Text>
              <Text style={{ fontSize: 12, marginBottom: 4 }}>75</Text>
              <Text
                style={{
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                ...
                security deposit will be blocked on the driver’s credit card.
                This deposit is determined by the car rental company considering
                your selected car category. Please be informed that the value of
                one tank of fuel and possible traffic fines can be additionally
                blocked on your credit card. It is recommended to present a
                credit card with chip, pin code and embossed numbers. Please
                note that you will have to present evidence that your credit
                card company / or your personal car insurance will be liable
                also against car rental damages. Otherwise, the car rental
                company may request you to leave a security deposit up to the
                value of the car or you may need to consider buying an extra
                coverage at time of pick-up to reduce the liability.{" "}
              </Text>
            </View>
            <View style={{ width: "100%", height: "100%", padding: "40px" }}>
              <Text
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                Under certain weather conditions winter or four season tires
                (mud and snow rated tires) and/ or snow chains are recommended
                or mandatory in certain destinations, for instance mountains or
                mountainous regions within the winter season (usually between
                November and April). Additional surcharges may apply and are
                payable in the local currency at the rental desk. Please check
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                ...
                or your personal car insurance will cover your damage excess.
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                ...
                customer will be picked up from CHECK IN 2 EXIT which is in the
                2nd Floor (Top Floor) from the Arrival Terminal. If you require
                any assistance please contact us on +41 76 495 90 10• Hotel /
                Apartment Deliver only possible on request by the time of
                booking with extra charge of 100 CHF / way plus local taxes
                within a 15 Kms radius of the station and additional Km will be
                charge 5 CHF Please note, the Priceless Car Rental is not
                obligated to wait for your arrival, and if you fail to arrive at
                the pick-up station at the time indicated in the voucher, it may
                constitute a No-Show on your part. At the end of the rental
                period, you must return the vehicle undamaged and in a clean
                ...
                date and time;fail to provide the documentation that is required
                ...
                such a case, unless the rental has been cancelled in advance,
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                ...
                hours maybe subject to an out of hours fee, payable locally at
                the rental desk.
              </Text>
            </View>
            <View style={{ width: "100%", height: "100%", padding: "40px" }}>
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                Cross-border travel is not usually permitted. Cross-border may
                or may not be available if you intend to drive to different
                islands within the same country or outside the country/state
                (for example, US/CAN). Charges may apply if available. It is
                MANDATORY to notify the rental agent of your plan to cross
                borders PRIOR TO THE PICK-UP DAY (it is usually recommended to
                do this at least 48 hours in advance). Please include the name
                of the country, state, or island you would like to visit. In
                this manner, the rental agent will confirm whether the car you
                have reserved is appropriate and fully insured for any potential
                cross-border travel.
              </Text>
              ...
              >
                ...
                rental desk. However there are special offers or promotions
                where the additional driver surcharge for a minimum of one
                driver is included in the rental price. In this case it is
                clearly stated under the listed price inclusions.
              </Text>
              ...
              >
                ...
                chip, pin code and embossed numbers and it must be valid at
                least 3 months after the drop-off date of the rented car
              </Text>
              ...
              >
                ...
                rentals. The credit cards must not be from the same issuer but
                the required deposit amount must be available on only one of the
                cards.{" "}
              </Text>
              <Text
                style={{
              ...
              >
                ...
                this case, your reservation will be charged in accordance with
                the agreed no-show policy.{" "}
              </Text>
              ...
              >
                ...
                request a valid credit card with enough funds at time of pick
                up. Compulsory documents are determined by the supplier and are
              ...
              >
                Compulsory documents for domestic rentals within or Latin
                America
              </Text>
              <Text
                style={{
              ...
              >
                Suppliers in Latin America usually accept a valid Passport
                rather than an ID card. Please be aware in case you fail to
                bring the respective and compulsory documents suppliers will
                decline the handover of the reserved and prepaid rent a car.{" "}
              </Text>
              <Text
                style={{
                  fontSize: 12,
              ...
              >
                At time of pick-up, the following physical documentation issued
                in the main driver´s name must be presented at the rental desk
                referring to the supplier's reservation confirmation reference
                number:{"\n\n"}- Voucher where applicable{"\n"}- Valid
                Passport/or ID card (For domestic rentals ID card may be
                mandatory){"\n"}- Valid Driving License{"\n"}- Valid Credit Card
                with PIN CODE in the same name as the driver license{"\n"}-
                Fiscal Code (applicable for Italian customers with destination
                Italy){"\n\n"}
            ...
            <View style={{ width: "100%", height: "100%", padding: "40px" }}>
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                ...
                required years of driving experience may vary according to the
                car category, country or car rental supplier.
              </Text>
              <Text
                style={{ fontSize: 12, fontWeight: "bold", marginBottom: 5 }}
              >
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                International rentals may have different requirements. We
                strongly advise you to check individual country or car rental
                supplier requirements as you may be asked to provide additional
                documentation or/and an international driving license. If an
                International Driving License is required, you will need to
                present both your international driver's license and your
                domestic license for pick-up. For holders of a UK driving
                license please visit DVLA for an update on recent changes to the
                paper counterpart effective from 8th June 2015. When renting in
                the United States the legal terms for 12-17 passenger van
                rentals may differ as per rental destination. Please check the
                local requirements for driving license policy.{" "}
              </Text>
              <Text
                style={{ fontSize: 12, fontWeight: "bold", marginBottom: 5 }}
              >
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                If your domestic driving license is issued in non-Latin
                characters (e.g. Arabic, Chinese, Cyrillic...etc.), you will
                need to present an International Driving Permit in addition to
                your domestic driving license. Please remember that you must
                carry both documents also when driving your rental car.If the
                International Driver's Permits cannot be issued by your home
                Country (e.g. drivers from People's Republic of China), you may
                be allowed to present your domestic driving license accompanied
                by a Notarised Translation instead. We strongly recommend
                verifying the international driving license regulations
                applicable for your Country of pick-up, or to contact your
                Embassy for more information. Please keep in mind, however, that
                while a certain Country’s regulations may not require an
                International Driver's Permit, some car rental suppliers located
                in that Country may require to present the International
                Driver's Permit anyway.
              </Text>
              <Text
                style={{ fontSize: 12, fontWeight: "bold", marginBottom: 5 }}
              >
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                ...
                accepted in combination with a translation of the driver's
                license issued from Japan Automobile Federation (JAF), more
                information is available here:
                http://www.jaf.or.jp/e/translation/with.htm. Chinese driving
                licenses are not accepted in Japan at all also not in
                combination with official translations.
              </Text>
              <Text
                style={{ fontSize: 12, fontWeight: "bold", marginBottom: 5 }}
              >
              ...
              <Text style={{ fontSize: 9, marginBottom: 4 }}>
                ...
                pick-up a valid credit card in main driver's name is required as
                a guarantee. Prepaid or debit cards, such as Maestro, Visa
                electron, Visa Premier or Carte Bleue are not accepted. The
                actual charge to your credit card may vary according to the
                exchange rate used and/or additional fees imposed by your bank.
                Please note that payments at pick-up are subject to local
                currency.
              </Text>
