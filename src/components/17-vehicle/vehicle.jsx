...
const VehicleStep = ({ bookingData, updateBookingData, onContinue, onBack }) => {
  ...
  //       options={{ disableDefaultUI: true, styles: [{ featureType: "all", stylers: [{ saturation: -100 }] }] }}
  //     >
  //       {!directions && (
  //         <DirectionsService
  //           options={{
  ...
  const handleBack = () => {
    // Navigate back to the booking form page
    navigate('/transfer');
  };
        ...
        {directions && (
          <DirectionsRenderer
            options={{
              directions,
              polylineOptions: {
                strokeColor: "#F4A300", // Same as Transfeero orange
                strokeWeight: 5,
              },
